...
export const PAGES = {
  '/': {
    title: `${SITE.name} | Design & Development 👨‍💻`,
    description:
...
export const SOCIAL_MEDIA = [
  {
    url: 'https://www.facebook.com/bvgsoftware',
    name: 'Facebook',
    icon: ['fab', 'facebook-f']
  },
  {
    url: 'https://www.linkedin.com/in/benjamin-brooke-957b2310a/',
    name: 'LinkedIn',
    icon: ['fab', 'linkedin-in']
  },
  { url: 'https://dev.to/benjaminadk', name: 'DEV', icon: ['fab', 'dev'] }
]
...
export const RECAPTCHA_KEY = '6LdkKrYZAAAAAOeV_fki-OrD7ictfQ3RAJGXpIQm'
export const RECAPTCHA_SECRET = '6LdkKrYZAAAAADfFn41ybScHaL7TSdSHYg-9Sxmi'
