...
export const PAGES = {
  '/': { title: `${SITE.name} | Modern Business Solutions`, description: '' },
  '/services': {
    title: `Web & Mobile Development | ${SITE.name}`,
    description: ''
  },
  '/posts': { title: `Learn To Code Blog | ${SITE.name}`, description: '' },
  '/contact': { title: `Free Consultation | ${SITE.name}`, description: '' }
}
